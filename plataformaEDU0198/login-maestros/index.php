...
<html >
<head>
<link rel="shortcut icon" href="imagenes/profesor.png">
  <meta charset="UTF-8">
...
<body>
  ...
  <nav>
    <ul>
      ...
      <li><a href="index.php">Iniciar Maestros</a></li>
  ...
  <div class="form">
    ...
    <form class="login-form" name="login_maestros" action="php/login.php" method="post">
    <h1>Login Maestros</h1>
      <input type="text" id="username" name="username" placeholder="Matricula ó Email"/>
